...
//                 <tbody>
//                   {liveData.live.map((reg: any, idx: number) => (
...
//                             </div>
//                           ) : (
//                             <div className="flex items-center justify-center w-8 h-8 text-xs font-medium text-blue-600 bg-blue-100 rounded-full">
