...
import {CardWithLogs,PhoneDetectionLogs,PersonDetectionLogs, ExternalLogs, WarningCountLogs} from "./LogCard";
...
function DisciplineCard({ discData, wstatus, onClick }: any) {
  return (
    ...
    >
      {/* Show Terminated badge if wstatus is 1 */}
      {wstatus === 1 && (
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* Show Attempted tag if wstatus is not 1 */}
        {wstatus !== 1 && (
          <div className="px-2 py-1 text-xs font-medium text-blue-600 bg-blue-100 rounded-full">
            Attempted
          </div>
