...
const FifteenMinNumbers: React.FC<Props> = ({ onStart }) => {
  ...
  const startGame = () => {
    const grouping = parseInt(formState.grouping);
  ...
  return (
    ...
    <div className="bg-white rounded-lg p-4 shadow-sm">
      ...
      <ul className="list-disc list-inside text-gray-700 space-y-1">
        <li>Game consists of <span className="font-medium">2 pages</span></li>
        <li>Each page shows <span className="font-medium">10 rows</span> with <span className="font-medium">30 numbers</span> per row</li>
        <li>Memorize numbers in the <span className="font-medium">exact same order</span> as shown</li>
      </ul>
    </div>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    <span className="font-medium">Memorization (15 minutes):</span>
                    Study the numbers shown
                  </li>
                  <li>
                    <span className="font-medium">Recall (15 minutes):</span> Enter
           ...
           <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    <span className="font-medium">Grouping Size:</span> Choose
                    how many numbers to group together (1-9)
                  </li>
                  <li>
                    <span className="font-medium">Visual Lines:</span> Option to
                    add separator lines between groups
                  </li>
                  <li>
                    <span className="font-medium">Highlight Color:</span> Select
                    your preferred color for active groups
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm space-y-6">
                ...
                {presetColors.map((color) => (
                  <button
                    ...
                    style={{
                      ...
                      border:
                        formState.highlightColor === color
                          ? "2px solid black"
                          : "2px solid white",
                    }}
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>
                  <span className="font-medium">Enter:</span> Move to next
                  phase(eg. memorization to recall)
                </li>
                <li>
                  <span className="font-medium">Backspace:</span> Clear and move
                  back
                </li>
                <li>
...
export default FifteenMinNumbers;
