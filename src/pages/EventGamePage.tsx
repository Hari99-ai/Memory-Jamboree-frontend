...
function EventGamePage() {
  ...
  useEffect(() => {
    ...
    console.log("hasConfig:", !!(state && state.config))
    console.log("fromEvent:", !!(state && state.fromEvent))
    console.log("event_id exists:", !!event_id)
    console.log("discipline exists:", !!discipline)
